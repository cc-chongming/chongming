...
public enum ReviewEventType {
    ...
    TASK_ASSIGNED(ReviewEventCategory.TASK),
    TASK_HANDOFF(ReviewEventCategory.TASK),
    TASK_PAUSED(ReviewEventCategory.TASK),
    TASK_RESUMED(ReviewEventCategory.TASK),
    TASK_SUBMITTED_FOR_ACCEPTANCE(ReviewEventCategory.TASK),
    TASK_ACCEPTED(ReviewEventCategory.TASK),
    TASK_REJECTED(ReviewEventCategory.TASK),
    TASK_CANCELLED(ReviewEventCategory.TASK),
