...
public class ReviewDirectorHarnessFactory {
    ...
    private String directorPrompt() {
        return "You are ReviewDirectorHarness. Create and revise public review plans with plan_enter, plan_write, "
                ...
                + "Each topic must include both supporting (SUPPORT) and opposing (OPPOSE) Claims for that subject so both sides are represented in the debate; never open a topic with only one side's Claims. "
