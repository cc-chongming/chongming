...
<template>
    <section class="scout-conclusion-panel" aria-labelledby="scout-conclusion-title">
        ...
        <div v-if="conclusion" class="scout-conclusion-body">
            ...
            <details v-if="evidencePaths.length || conclusion.rawPublicResult" class="scout-full-context">
                ...
                <SafeMarkdown v-if="conclusion.rawPublicResult" :content="conclusion.rawPublicResult" />
            </details>
        </div>
